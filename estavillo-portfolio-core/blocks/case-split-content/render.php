<?php
/**
 * Render dinámico de estavillo/case-split-content: la región de TEXTO de un
 * Case Section en layout Split. Solo un wrapper con la clase de grilla —
 * la columna exacta (1–5, 8–12 o 1–6 según el split) la decide el CSS del
...
?>
<div <?php echo get_block_wrapper_attributes( array( 'class' => 'es-case-split__content' ) ); // phpcs:ignore WordPress.Security.EscapeOutput -- ya escapado por core. ?>>
